...
class CorsMiddleware implements MiddlewareInterface {
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface {
        ...
        $settings->setForceAddAllowedHeadersToPreFlightResponse($this->config->forceAddAllowedHeadersToPreflightResponse());
        $settings->setForceAddAllowedMethodsToPreFlightResponse($this->config->forceAddAllowedMethodsToPreflightResponse());
